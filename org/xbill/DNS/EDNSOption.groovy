 ...
 */
abstract void optionFromWire(DNSInput dnsin) throws IOException;
 ...
 */
static EDNSOption fromWire(DNSInput dnsin) throws IOException {
	int code, length;
	...
	option.optionFromWire(dnsin);
	dnsin.restoreActive(save);
